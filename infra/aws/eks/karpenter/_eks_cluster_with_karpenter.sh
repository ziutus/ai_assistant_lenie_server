...
STEP=0
export CLUSTER_NAME="lenie-karpenter-poc1"
export K8S_VERSION="1.30"
export KARPENTER_VERSION="0.37.0"
export AWS_DEFAULT_REGION="us-east-1"
export INSTANCE_TYPE="t2.medium"
export AWS_PROFILE="lenie_admin"
...
if [[ ${ACTION} == "create" ]] && [[ $STEP -le 2 ]]; then
  echo ">STEP 2: Creating EKS cluster using eksctl command"
...
iam:
  ...
  serviceRoleARN: arn:${AWS_PARTITION}:iam::${AWS_ACCOUNT_ID}:role/${CLUSTER_NAME}-karpenter
