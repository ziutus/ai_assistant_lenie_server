...
aws lambda publish-layer-version --layer-name psycopg2_layer --zip-file fileb://./psycopg2_layer.zip --compatible-runtimes python3.10 --profile stalker-free-developer